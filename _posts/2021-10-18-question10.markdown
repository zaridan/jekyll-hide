...
<p>I would like to assure you that we will take all necessary steps to resolve any discovered security issues, and we will be sure to alert all customers to any necessary steps should they be needed.</p>
